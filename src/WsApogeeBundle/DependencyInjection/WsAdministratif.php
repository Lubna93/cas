...
class WsAdministratif extends WebService
{
    ...
    // public function recupererIAAnnuelles_v2(User $user, string $codEtu, string $annee = '', EtatIA $etatIAA = null)
    // {
    //     $etatIAA = $etatIAA != null ? $etatIAA : EtatIA::enCours();
    //     if(!$codEtu){
    //     $codEtu=$this->entityManager->getRepository(User::class)->findOneBy(["codEtu"=>$codEtu]);
    //         return $this->soapCall('recupererIAAnnuelles_v2', [
    //             '_codEtu' => $codEtu,
    //             '_annee' => $annee,
    //             '_etatIAA' => $etatIAA->getEtat()
